...
func UpdateOfflineTradeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := offlinetrade.NewUpdateOfflineTradeLogic(r.Context(), svcCtx)
		resp, err := l.UpdateOfflineTrade(&req)
